...
test("#152 PDF real incorpora fontes, preserva Unicode e quebra textos extensos", async () => {
  ...
  const report = {
    ...
    indicadores: { totalAtendimentos: 8, presentes: 8, ausentes: 0, feriados: 0, recessos: 0, naoInformado: 0, taxaPresencaPercent: 100, tempoTotalMinutos: 400, mediaMinutosPorSessao: 50, primeiroAtendimento: null, ultimoAtendimento: null },
