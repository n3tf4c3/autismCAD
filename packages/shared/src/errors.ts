...
export function toAppError(error: unknown, options?: { exposeMessage?: boolean }): AppError {
  ...
  // When enabled (development/test), surface the underlying message to speed up debugging.
