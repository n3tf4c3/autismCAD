import { normalizeDateOnlyLoose, normalizeOptionalText } from "./normalize";
...
// Sanitizer canonico do payload de plano de ensino, compartilhado entre runtime e
// scripts (achado 64). As datas sao normalizadas no timezone da aplicacao (achado 63),
// recebido como parametro para nao depender de `server-only`/env do app.
export function sanitizePlanoEnsinoPayload(input: unknown, timeZone: string): PlanoEnsinoPayload {
